...
const pageSchema = {
  ...
  "description": "An online matrix calculator that performs addition, subtraction, multiplication, finds the determinant, inverse, and transpose of matrices. Includes a guide on how to use it effectively.",
  "url": "https://maths.calculation.site/matrix/calculator",
  "publisher": {
    "@type": "Organization",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [{
    ...
    "position": 4,
    "name": "Matrix Calculator",
    "item": "https://maths.calculation.site/matrix/calculator"
  }]
};
