...
const pageSchema = {
  ...
  "name": "Augmented Matrix & RREF Calculator",
  "operatingSystem": "All",
  "applicationCategory": "EducationalApplication",
  "description": "An online tool to solve systems of linear equations by converting an augmented matrix into Reduced Row Echelon Form (RREF). Supports step-by-step manual row operations.",
  "url": "https://maths.calculation.site/rref",
  "publisher": {
    "@type": "Organization",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [{
    ...
    "item": "https://maths.calculation.site/rref"
  }]
};
