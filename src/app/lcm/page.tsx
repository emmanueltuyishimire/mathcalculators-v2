...
const pageSchema = {
  ...
  "description": "Find the least common multiple (LCM) of a set of numbers with our free online LCM calculator, complete with step-by-step solutions.",
...
const breadcrumbSchema = {
  ...
  "itemListElement": [{
    ...
    "position": 3,
    "name": "LCM Calculator",
    "item": "https://maths.calculation.site/lcm"
  }]
};
